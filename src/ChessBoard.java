 ...
 * [ChessBoard.java]
 * @author JoleneZheng
 * This class holds all the GUI contents, and controls alternating between the user and the computer
 * This class extends the JPanel class, and implements MouseListener
 * Pieces images taken from: https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Chess_Pieces_Sprite.svg/2000px-Chess_Pieces_Sprite.svg.png (Accessed on December 5th)
 * December 11th, 2017
 */
class ChessBoard extends JPanel implements MouseListener {
	...
	ChessBoard(JFrame runFrame) {
		...
		try { //reads the files at the beginning of game
			...
			boardImage = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/ChessBoard.png"));

			//image of black pieces
			bKing = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/BlackKing.png"));
			bQueen = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/BlackQueen.png"));
			bRook = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/BlackRook.png"));
			bBishop = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/BlackBishop.png"));
			bKnight = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/BlackKnight.png"));
			bPawn1 = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/BlackPawn.png"));
			bPawn2 = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/BlackPawn.png"));
			bPawn3 = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/BlackPawn.png"));
			bPawn4 = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/BlackPawn.png"));
			bPawn5 = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/BlackPawn.png"));

			//image of white pieces
			wKing = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/WhiteKing.png"));
			wQueen = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/WhiteQueen.png"));
			wRook = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/WhiteRook.png"));
			wBishop = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/WhiteBishop.png"));
			wKnight = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/WhiteKnight.png"));
			wPawn1 = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/WhitePawn.png"));
			wPawn2 = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/WhitePawn.png"));
			wPawn3 = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/WhitePawn.png"));
			wPawn4 = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/WhitePawn.png"));
			wPawn5 = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/WhitePawn.png"));

			//winner images
			bWinsImage = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/BlackWins.png"));
			wWinsImage = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/WhiteWins.png"));
			tieGameImage = ImageIO.read(new File("/Users/JoleneZheng/Codes/Grade 12 Computer Science/Quick Chess/TieGame.png"));
