 ...
 * This class stores the constructor, getters and setters for a Move object
 * Used to store/retrieve each piece's current position, and the position they are moving to. It also has the value of the move.
 * December 11th, 2017
 */
public class Move {
